export function customEmailHtml(subject: string, message: string, year: number = new Date().getFullYear()): string {
  return `
  <!DOCTYPE html>
  <html lang="en">
  <head>
    ...
    <style>
      ...
      .subject { font-size: 20px; font-weight: 600; color: #111827; margin-bottom: 10px; }
